...
public:
	ProjectSettings(JsonObject project){
		m_project = project;
	}

	String input_directory_path() const { return m_project.at("input").to_string(); }
	String output_directory_path() const { return m_project.at("output").to_string(); }
